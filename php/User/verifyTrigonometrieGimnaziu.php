...
$query1 = "SELECT score FROM trigonometrie_gimnaziu WHERE ID =:id_pr";
$query = "SELECT answear FROM trigonometrie_gimnaziu  WHERE ID =:id_pr";
...
if($row['answear'] == $post and $user->insertPairTG()){
...
else if($user->alreadyResolvedTG() == true){
   $update_score = array(
