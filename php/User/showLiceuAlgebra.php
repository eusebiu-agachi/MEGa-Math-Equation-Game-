...
include_once '../html/liceuAlgebra.php';

function showLiceuAlgebra(){
   ...
   $this_page_first_result = ($page-1)*$result_per_page;
    ...
    $sql = "SELECT ID, title, text_problem, score FROM algebra_liceu LIMIT " . $this_page_first_result .',' . $result_per_page;
    ...
    for($page = 1; $page <= $number_of_pages; $page++){
        echo '<a href="../html/liceuAlgebra.php?page=' .$page . '" class="pages">' .$page . '</a> ';
    }    
} 