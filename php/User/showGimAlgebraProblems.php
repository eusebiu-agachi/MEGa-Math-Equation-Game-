...
include_once '../html/gimAlgebra.php';



function showAlgebraGimnaziu(){
   ...
   $this_page_first_result = ($page-1)*$result_per_page;
    ...
    $sql = "SELECT ID, title, text_problem, score FROM algebra_gimnaziu LIMIT " . $this_page_first_result .',' . $result_per_page;
    ...
    while($row = $result->fetch(PDO::FETCH_ASSOC)){
     ...
     for($page = 1; $page <= $number_of_pages; $page++){
        echo '<a href="../html/gimAlgebra.php?page=' .$page . '" class="pages">' .$page . '</a> ';
    }
}
